...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div data-site-nav-bar className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          
          {/* Logo */}
          <a
            href="#hero"
            onClick={(event) => scrollToNavItem(event, "#hero")}
          ...
          <div className="hidden md:flex items-center space-x-1">
            {navItems.map((item) => (
              <a
                key={item.label}
                href={item.href}
                onClick={(event) => scrollToNavItem(event, item.href)}
